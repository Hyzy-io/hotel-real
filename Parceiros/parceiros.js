...
function renderizarParceiros() {
  const _containerCheck = document.getElementById('partners-list');
  if (!_containerCheck) return;
    var container = document.getElementById('partners-list'); if (!container) return;
  if (!container) return;
