...
function generatePartnerProfileHTML(partner) {
    ...
    if (partner.social) {
        if (partner.social.instagram) {
            socialIconsHTML += `<a href="https://instagram.com/${partner.social.instagram}" class="social-icon" target="_blank" rel="noopener noreferrer"><i class="fab fa-instagram"></i></a>`;
        }
        if (partner.social.facebook) {
            socialIconsHTML += `<a href="https://facebook.com/${partner.social.facebook}" class="social-icon" target="_blank" rel="noopener noreferrer"><i class="fab fa-facebook"></i></a>`;
        }
        if (partner.social.twitter) {
            socialIconsHTML += `<a href="https://twitter.com/${partner.social.twitter}" class="social-icon" target="_blank" rel="noopener noreferrer"><i class="fab fa-twitter"></i></a>`;
        }
    }
